...
def _test_private_version_and_user_marker_are_synchronized(self: unittest.TestCase) -> None:
    ...
    self.assertEqual(version, "1.1.18-private.1")
    ...
    self.assertGreater(base.parse_semver("1.1.18-private.1"), base.parse_semver("1.1.17-private.13"))
    self.assertEqual(base.NEXT_PACKAGE_VERSION, "1.1.18-private.2")
