...
The current version is `1.1.18-private.4`, selectively aligned to upstream
...
python3 -B scripts/package_release.py --verify /absolute/path/to/fresh-output/codex_workflow-1.1.18-private.4.zip
```

Expected release assets:

- `codex_workflow-1.1.18-private.4.zip`
- `SHA256SUMS`
...
publishes a prerelease for tag `v1.1.18-private.4` with exactly the expected ZIP
