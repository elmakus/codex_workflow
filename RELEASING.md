...
The current version is `1.1.17-private.4`, based directly on upstream `v1.1.17`
...
python3 -B scripts/package_release.py --verify /absolute/path/to/fresh-output/codex_workflow-1.1.17-private.4.zip
```
...
- `codex_workflow-1.1.17-private.4.zip`
- `SHA256SUMS`
